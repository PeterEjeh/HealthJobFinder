      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            id="datePostedFilter"
            value={filters.datePostedFilter}
            onChange={handleInputChange}
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-cyan-500 focus:border-cyan-500"
          >
        ...
        <div className="space-y-3 border-t pt-4">
          <div className="flex items-center">
            <input
              ...
              onChange={(e) =>
                setFilters({
                  ...filters,
                  visaSponsorshipRequired: e.target.checked,
                })
              }
              className="h-4 w-4 rounded border-gray-300 text-cyan-600 focus:ring-cyan-500"
            />
            <label
              htmlFor="visaSponsorshipRequired"
          ...
          <div className="flex items-center">
            <input
              id="internationalApplicantsOnly"
              type="checkbox"
              name="internationalApplicantsOnly"
              checked={filters.internationalApplicantsOnly}
              onChange={(e) =>
                setFilters({
                  ...filters,
                  internationalApplicantsOnly: e.target.checked,
                })
              }
              className="h-4 w-4 rounded border-gray-300 text-cyan-600 focus:ring-cyan-500"
            />
            <label
              htmlFor="internationalApplicantsOnly"
              className="ml-3 text-sm font-medium text-gray-700"
            >
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            .txt, .pdf, or .docx for personalization.
          </p>
          {resumeFile && (
