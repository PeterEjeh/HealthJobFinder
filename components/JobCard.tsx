    ...
    <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200 hover:shadow-lg hover:border-cyan-300 transition-all duration-300">
      <div className="flex flex-col sm:flex-row justify-between sm:items-start">
        ...
        <a
          ...
          className="mt-4 sm:mt-0 sm:ml-4 inline-block bg-cyan-100 text-cyan-800 font-semibold py-2 px-5 rounded-full hover:bg-cyan-200 transition-colors text-sm whitespace-nowrap"
        >
          Apply Now
        </a>
      </div>
